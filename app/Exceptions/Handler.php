...
class Handler implements ExceptionHandlerContract
{
    ...
    public function render($request, Throwable $e)
    {
        ...
        if ($e instanceof QueryException) {
            ...
            {
                if ($code == 1062) {
                    return response()->json(['error' => 'Entrada duplicada.', 'code' => 1062]);
                }
            }
        }
        if ($e instanceof NotFoundHttpException) {
            if( $request->is('api/*'))
            {
                return response()->json(['error' => 'No se encontró la URL especificada.', 'code' => 404]);
            }
        }
        if ($e instanceof HttpResponseException) {
            ...
            if( $request->is('api/*'))
            {
                return response()->json(['error' => 'No autenticado.', 'code' => 401]);
            }
